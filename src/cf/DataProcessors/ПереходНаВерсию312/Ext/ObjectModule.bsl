...
Процедура ИзменитьВыгруженныеТексты(Параметры)
	...
	Номер = 0;
	Для Каждого СтрокаВида Из Параметры.ДеревоМетаданных.Строки Цикл // СтрокаДереваЗначений: см. ДеревоМетаданных
		...
		Если Не ФайлСуществует(СтрокаВида.Каталог) Тогда
			...
			Продолжить;
		КонецЕсли;
		Для Каждого СтрокаОбъекта Из СтрокаВида.Строки Цикл // СтрокаДереваЗначений: см. ДеревоМетаданных
			// Прогресс анализа.
			Номер = Номер + 1;
			...
			Для Каждого СтрокаФормы Из СтрокаОбъекта.Строки Цикл // СтрокаДереваЗначений: см. ДеревоМетаданных
