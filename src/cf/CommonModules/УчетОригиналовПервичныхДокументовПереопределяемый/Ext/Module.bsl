...
Процедура ПриОпределенииОбъектовСКомандамиУчетаОригиналов(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить("Документ._ДемоОтпускаСотрудников.ФормаСписка");
	СписокОбъектов.Добавить("Документ._ДемоРеализацияТоваров.ФормаСписка");
	СписокОбъектов.Добавить("Документ._ДемоПеремещениеТоваров.ФормаСписка");
